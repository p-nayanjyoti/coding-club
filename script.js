...
function productTemp(prod) {
    return `
    <div class="product">

          <img class="product-photo" src ="${prod.thumbnail}">
          <h2 class="prod-title" >${prod.title}
          <p><strong>description:</strong> ${prod.description}</p>
          <p><strong>price:</strong> ${prod.price}</p>
          <p><strong>discountPercentage:</strong> ${prod.discontPercentage}</p>
